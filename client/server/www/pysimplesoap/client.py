...
<%(soap_ns)s:Body>
    ...
    def call(self, method, *args, **kwargs):
        ...
        xmlout = response.as_xml()    # lengy add in 2014.05.07
        domxml = minidom.parseString(xmlout)   # lengy add in 2014.05.07
        content = domxml.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].nodeValue   # lengy add in 2014.05.07
        return content   # lengy add in 2014.05.07
		#return response
